...
<task type="checkpoint:human-verify" gate="blocking">
  ...
  <how-to-verify>
    ...
    **3. Scrolling performance (60fps check)**
    - If you have a large diff (100+ lines), hold down `j` for 3 seconds
    - The panel should scroll smoothly without visible stutter
    - If you have access to a repo with 1000+ lines of changes, navigate to it and repeat
